...
<html>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('form').on('click', '#btn', function(){
                    var novaURL = "cadastro_cosif.php";
    ...
    <div id="cnt">
        ...
        <div id="cnt_02">
            ...
            <div id="cnt_02_02">
                <div id="cnt_02_02_01">Cadastro / Plano de Contas / Incluir</div>
                <div id="cnt_02_02_02">
                    <form action="cadastro_cosif_incluir.php" method="post">
                        ...
                        <label class="form">Item de débito </label>
                        <input type="text" name="nro_itm_deb" value="">
                        <label class="form">Item de crédito </label>
                        <input type="text" name="nro_itm_cre" value="">
                        <input type="submit" value="Cadastrar COSIF" />
                    ...
                    if (isset($_POST['cod_csf'])){
                        ...
                        if ($cod_csf != ""){
                            ...
                            $consulta = "INSERT INTO tbl_pln_cta_csf (cod_csf, nm_csf, nro_itm_deb, nro_itm_cre) 
                                                    VALUES ('$cod_csf', '$nm_csf', '$nro_itm_deb', '$nro_itm_cre')";
                            $resultado = $mysqli->query($consulta, MYSQLI_STORE_RESULT);
                            echo "<script>window.location.href = 'cadastro_cosif.php';</script>";
                        }
                    }
                    ?>
                </div>
