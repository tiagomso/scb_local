...
<html>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('form').on('click', '#btn', function(){
                    var novaURL = "cadastro_partidas.php";
    ...
    <div id="cnt">
        ...
        <div id="cnt_02">
            ...
            <div id="cnt_02_02">
                <div id="cnt_02_02_01">Cadastro / Partidas Dobradas / Incluir</div>
                <div id="cnt_02_02_02">
                    <form action="cadastro_partidas_incluir.php" method="post">
                    ...
                    if (isset($_POST['cod_csf'])) {
                        ...
                        if ($cod_csf != "") {
                            ...
                            echo "<script>window.location.href = 'cadastro_partidas.php';</script>";
                        }
                    }
                    ?>
                </div>
