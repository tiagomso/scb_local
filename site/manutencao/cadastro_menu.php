...
<div id="cnt">
    ...
    <div id="cnt_02">
        ...
        <div id="cnt_02_02">
            <div id="cnt_02_02_01">cnt_02_02_01</div>
            <div id="cnt_02_02_02">
                <a class="btn" href="cadastro_cosif.php">Plano de Contas</a>
                <a class="btn" href="cadastro_eventos.php">Eventos Contábeis</a>
                <a class="btn" href="cadastro_partidas.php">Partidas Dobradas</a></br>
                <a class="btn" href="cadastro_contas_bancarias.php">Contas Bancárias</a>
                <a class="btn" href="cadastro_convenios.php">Convênios</a>
                <a class="btn" href=#>Usuários</a>
            </div>
        </div>
    </div>
</div>
