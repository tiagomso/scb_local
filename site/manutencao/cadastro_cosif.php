...
<div id="cnt">
    ...
    <div id="cnt_02">
        ...
        <div id="cnt_02_02">
            <div id="cnt_02_02_01">Cadastro / Plano de Contas</div>
            <div id="cnt_02_02_02">
                <div id="barra_ferramentas">
                    <div id="esp" class="btn_div"></div>
                    <div id="inc" class="btn_div"><a class="btn" href="cadastro_cosif_incluir.php">Incluir</a></div>
                ...
                <form action="" method="post">
                    <table id="extrato" class="display" nome="COSIF" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th></th>
                                <th>Identificador</th>
